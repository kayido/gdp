    ...
    <div class="overlay">
        <div class="head-main-staff">
            ...
            <div class="filter-staff">
                <span class="filt-personnel view-staff"><a href="personnel.php">personnel</a></span>
                <span class="filt-equip"><a href="candidat.php">candidat</a></span>
            </div>         
        </div>
            ...
            <caption></caption>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../delete.php?id=<?= $row["id_perso"]?>&class=1"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                <?php 
                    endwhile; 
